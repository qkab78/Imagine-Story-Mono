...
test.group(StoryBuilder.name, () => {
    ...
    test('should throw an error if the species is not set', async ({ assert }) => {
        const storyBuilder = StoryBuilder.create(new TestDateService()).withId(new StoryId(new TestRandomService())).withTitle('The title of the story').withSynopsis('The synopsis of the story').withProtagonist('The protagonist of the story').withChildAge(10).withNumberOfChapters(10)
        assert.throws(() => storyBuilder.build(), 'Species is required')
    })
    test('should throw an error if the conclusion is not set', async ({ assert }) => {
        const storyBuilder = StoryBuilder.create(new TestDateService()).withId(new StoryId(new TestRandomService())).withTitle('The title of the story').withSynopsis('The synopsis of the story').withProtagonist('The protagonist of the story').withChildAge(10).withNumberOfChapters(10).withSpecies('The species of the story')
    ...
    test('should throw an error if the cover image url is not set', async ({ assert }) => {
        const storyBuilder = StoryBuilder.create(new TestDateService()).withId(new StoryId(new TestRandomService())).withTitle('The title of the story').withSynopsis('The synopsis of the story').withProtagonist('The protagonist of the story').withChildAge(10).withNumberOfChapters(10).withSpecies('The species of the story').withConclusion('The conclusion of the story')
    ...
    test('should throw an error if the owner id is not set', async ({ assert }) => {
        const storyBuilder = StoryBuilder.create(new TestDateService()).withId(new StoryId(new TestRandomService())).withTitle('The title of the story').withSynopsis('The synopsis of the story').withProtagonist('The protagonist of the story').withChildAge(10).withNumberOfChapters(10).withSpecies('The species of the story').withConclusion('The conclusion of the story').withCoverImageUrl('The cover image url of the story')
