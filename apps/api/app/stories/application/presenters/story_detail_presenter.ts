...
import type { IStorageService } from '#stories/domain/services/i_storage_service'
import { ChapterPresenter } from './chapter_presenter.js'
import { ThemePresenter } from './theme_presenter.js'
import { LanguagePresenter } from './language_presenter.js'
import { TonePresenter } from './tone_presenter.js'
...
export class StoryDetailPresenter {
  ...
  public static async toDTO(
    ...
    const coverImageUrl = story.coverImageUrl
      ? await this.resolveImageUrl(story.coverImageUrl.getValue(), storageService)
      : null
