...
const Button = ({ onPress, label, disabled, textColor, bgColor, ...rest }: ButtonProps) => {
  const props = useRestyle(restyleFunctions, rest);
  return (
    <TouchableOpacity onPress={onPress} disabled={disabled}>
      <Box {...props} padding="m" borderRadius="m" backgroundColor={bgColor || "primaryCardBackground"} width={WIDTH * .5} justifyContent="center" alignItems="center">
